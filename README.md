...
Interaction to Next Paint (INP)	Measures the time from user interaction to when the browser renders the next frame.	200 millisecond or less
...
dark
"
 https://vercel.com/docs/speed-insights/metrics#:~:text=Search...,dark